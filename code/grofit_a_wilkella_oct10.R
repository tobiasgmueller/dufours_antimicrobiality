...
d <- read.csv("input/a_wilkella_10oct2023.csv")
labels <- read.csv("input/a_wilkella_11oct2023_platesetup.csv")%>%
...
write.csv(gr,"formatted_OD_values/a_wilkella_10oct2023", row.names = FALSE)
...
write.csv(grofit, "output/a_wilkella_10_oct_2023_grofitresults.csv", row.names = FALSE)
...
grofit<- read_csv("output/a_wilkella_10_oct_2023_grofitresults.csv")
